            ...
            <div>
                ...
                <form action="actions/createresume.action.php" method="post" class="row g-3 p-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="email_id" placeholder="your@gmail.com" class="form-control" required>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="1111111111" name="mobile_no" placeholder="Enter your moile number" max="9999999999"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="hobbies" placeholder="Enter your Hobbies" class="form-control" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Languages Known</label>
                        <input type="text" placeholder="Languages you known" name="languages" class="form-control" required>
                    </div>
