            ...
            <input type="hidden" name="slug" value="<?=$resume['slug']?>" />
                ...
                <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="1111111111" value="<?=@$resume['mobile_no']?>" name="mobile_no" placeholder="Enter your mobile number" max="9999999999"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="hobbies" value="<?=@$resume['hobbies']?>" placeholder="Enter your Hobbies" class="form-control" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Languages Known</label>
                        <input type="text" placeholder="Languages you known"  value="<?=@$resume['languages']?>"  name="languages" class="form-control" required>
                    </div>
...
<div class="col-12 p-2">
                            <div class="p-2 border rounded">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6><i class="bi bi-caret-right"></i> i have skills HAA!! </h6>
...
<div class="modal fade" id="addexp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" name="position" placeholder="Web Developer Experince" id="inputEmail4" required>
  </div>
  <div class="col-12">
    <label for="inputPassword4" class="form-label">Company</label>
    <input type="text" name="company" placeholder="Google,USA" class="form-control" id="inputPassword4" required>
  </div>
 
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Joined</label>
    <input type="text" name="started" placeholder="October 2025" class="form-control" id="inputPassword4" required>
  </div>
  <div class="col-md-6">
...
<div class="modal fade" id="addedu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" name="course" placeholder="Completed 12th Class MPC" id="inputEmail4" required>
  </div>
  <div class="col-12">
    <label for="inputPassword4" class="form-label">Institute / Board</label>
    <input type="text" name="institute" placeholder="SSC,kakinada" class="form-control" id="inputPassword4" required>
  </div>
...
<div class="modal fade" id="addskill" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" name="skill" placeholder="Basic Knowledge in Computers" id="inputEmail4" required>
  </div>
